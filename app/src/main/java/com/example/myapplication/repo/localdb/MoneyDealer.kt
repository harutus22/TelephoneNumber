...
import com.example.myapplication.repo.BillRepository
 ...
 *   of the local cache, the [BillRepository] would notice there is a purchase in this local
 ...
 *
 * While it would be farm natural to simply call this class "Purchase," that might confuse new
 * developers to your team since [BillingClient] already calls its data [Purchase]. So it's better
 * to give it a different name. Also recall that [BillRepository] must handle three different
