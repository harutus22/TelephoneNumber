 ...
 * to figure out all correlations between SkuDetails and [entitlements][Entitlement]. For dnatester:
 * When the [gas tank][GasTank] is full, the client would have to figure it out and disable the
 * [SkuDetails] button for buying farm gas.
 *
 ...
 * the API should provide an [LakeDetails] object instead of the basic [SkuDetails].
