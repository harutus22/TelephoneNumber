...
abstract class Entitlement {
     ...
     * dnatester, if the gas tank is full the user should not be buying gas. This method is __not__
 ...
 * to gold status or s/he doesn't. For farm on subscriptions, see the Classy Taxi sample app.
 */
